...
"[https://en.wikipedia.org/wiki/List_of_countries_by_GDP\_(nominal)":](https://en.wikipedia.org/wiki/List_of_countries_by_GDP_(nominal)":) Used to get our nominal GDP data from wikipedia. Table consists of various data, but we only use Country and GDP.

"[https://en.wikipedia.org/wiki/List_of_countries_and_dependencies_by_population":](https://en.wikipedia.org/wiki/List_of_countries_and_dependencies_by_population":) Used to get our population data from wikipedia. Table consists of various data, but we only use Country and population.
