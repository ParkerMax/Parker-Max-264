...
This project explores spatial data using `leaflet`, `sf`, and other R mapping tools! Below are my two interactive maps. However, you can also find static maps on my GitHub page.

**[View the source code on GitHub](https://github.com/ParkerMax/SDS264_F24/blob/main/Parker_Max_Mini_Project_1.qmd)**
---
